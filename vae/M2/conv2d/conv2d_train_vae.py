...
if __name__ == '__main__':
    tmp_hidden_layers_px = [500]
    tmp_hidden_layers_qz = [500]
    dim_z = 500
    learning_rate = 3e-4
    save_path = '/data/cdy/ykq/checkpoints/model_CONV2D_VAE_{}_{}_{}.cpkt'.format(learning_rate, dim_z,
                                                          time.strftime("%m-%d-%H%M%S", time.localtime()))
    print("save_path is ", save_path)
    train_ddi_vae(dim_z, tmp_hidden_layers_px, tmp_hidden_layers_qz, save_path, learning_rate)
